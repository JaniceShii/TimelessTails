...
import javax.swing.*;
public class GamePlayUIMagearna extends AbstractScreen implements PetStateListener{
    ...
    // constructor method
    public GamePlayUIMagearna(GameManager gm, Inventory inventory) {
        this.gm = gm;
    ...
    public void createUIElements() {
        ...
        try {
            image = ImageIO.read(getClass().getResourceAsStream("/portraits/magearnanormal.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            Thread.sleep(1000);
       ...
       //     scoreLabel.setText("<html><div style='text-align: center;'>Score:\n" + "<br>" + points + "</div></html>");
        ...
        //     // use <html> example text </html> to warp text
        //     // change text dynamically by creating a String example = "";
        //     // once ___ (button) has been clicked, use action listener to change this string at the top to whatever text should be displayed
        //     // do JLabel text = new JLabel(example); instead of what is below currently
        //     // change for actual thing
        //     showMessage("<html>You took " + nameString + " out for a walk! " + nameString + " ran all around the neighbourhood. " + nameString + "'s health increased by 25. Sleep and fullness decreased by 10.</html>");
    ...
    public void onStateChanged(String gifFileName, String portraitFileName) {
        createPetGIF("magearna" + gifFileName);
        createPetPortrait("magearna" + portraitFileName);
    }
