...
/**
 * The GamePlayUIMagearna class represents the main game interface where the player chooses Magearna as their pet.
...
public class GamePlayUIMagearna extends AbstractScreen implements PetStateListener{
    ...
    /**
     * Constructs a GamePlayUIMagearna object.
     *
    ...
    */
    ...
    public void createUIElements() {
        ...
        try {
            image = ImageIO.read(getClass().getResourceAsStream("/com/petgame/assets/magearnanormal.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
