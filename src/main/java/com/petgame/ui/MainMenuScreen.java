...
/**
 * The MainMenuScreen class represents the main menu screen of the Timeless Tails game.
 * It shows the logo, title, and buttons for starting a new game, continuing a saved game, 
 * accessing settings, and closing the application.
 * 
 * @version 1.0
...
public class MainMenuScreen extends AbstractScreen{
     ...
     * 
     * @param gm   The GameManager instance used for managing game states and transitions.
     * @param inv  The Inventory instance used for managing game inventory.
     */
    ...
    /**
     * Initializes and sets up all UI elements of the main menu screen.
     * Adds components such as logo, title, buttons, and info panels to the screen.
     */
    @Override
    public void createUIElements() {
        Color navyBlue = new Color(28, 57, 102, 255); 

        //Adds logo panel to the screen, with a logo label on top containing the logo image
        ...
        ImageIcon logoUnscaled = new ImageIcon(getClass().getClassLoader().getResource("com/petgame/assets/2212logo.png"));
        ...
        //Displays the name of the game on screen
        ...
        uiCircle.add(gameNameLabel);
            //Displays the start new game button, which initiates the gameplay
        ...
        //continue button for user to play a saved game file
        ...
        //option for player to close the game
        ...
        //displays a popup when player wants to close the game reminding user to save
        ...
        //group members names and course number
    ...
    /**
     * Determines if the game is allowed to be played based on parental control settings.
     * Checks if the current time is within the allowed play time range.
     * 
     * @return true if the game is allowed to be played, false otherwise.
     */
