...
/** 
 * InventoryLoader class is responsible for loading inventory data from a text file
 * into an Inventory instance. The text file should contain item details in a key=value format.
 * 
 * @version 1.0
