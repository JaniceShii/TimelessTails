...
/**
 * The {@code ParentalControlsScreen} class represents the user interface for parental controls,
 * allowing users to enable or disable time limits, revive pets, and view game statistics.
 * 
 * @version 1.0
...
public class ParentalControlsScreen extends AbstractScreen {
    ...
    /**
     * Constructs the screen with the specified {@code GameManager}.
     *
     * @param gm the {@code GameManager} used for screen navigation and game state management
     */
    ...
    /**
     * Initializes and configures all UI elements for the parental controls screen,
     * including buttons for enabling/disabling time limits, reviving pets, and viewing statistics.
     */
    @Override
