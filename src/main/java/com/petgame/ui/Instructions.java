...
public class Instructions extends AbstractScreen{
     ...
     */
    public Instructions(GameManager gm) {
        this.gm = gm;
        createUIElements();
    }
    ...
    public void createUIElements() {
        ...
        JLabel descLabel = new JLabel("<html><div style='text-align: center;'>" + "The objective of our specific game is to create an experience for users " + 
        "to learn about simple life skills and routine management. \n" + "Through an interactive and engaging pet simulator with mouse based interaction, " 
        + "users must take care of a pet of their choice and maintain the pet’s health stats.\n\n " + "There will be various activities that contribute to either increasing or decreasing the stats, such as... \n"
        + "</div></html>");
        descLabel.setHorizontalAlignment(SwingConstants.CENTER);
        descLabel.setVerticalAlignment(SwingConstants.CENTER);
        descLabel.setBounds(250, 45, 400, 400);
        ...
        continueButton.setBounds(395, 470, 100, 35);
        ...
        continueButton.addActionListener(e -> gm.showInstructions2());
