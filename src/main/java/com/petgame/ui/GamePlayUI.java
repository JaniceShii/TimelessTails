...
public class GamePlayUI extends AbstractScreen implements PetStateListener{
    ...
    */
    ...
    public void createUIElements() {
        ...
        try {
            image = ImageIO.read(getClass().getResourceAsStream("/com/petgame/assets/furfrounormal.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        JPanel sleepBarColor = new JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                 ...
                 // Get sleep percentage from pet instance
                ...
                if (sleepPercentage < 0.25) {
                 ...
                 // Calculate new width based on sleep percentage
        ...
        JPanel fullnessBarColor = new JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                 ...
                 // Get fullness percentage from pet instance
                ...
                if (fullnessPercentage < 0.25) {
                 ...
                 // Calculate new width based on fullness percentage
        ...
        JPanel happinessBarColor = new JPanel() {
            protected void paintComponent(Graphics g) {
                ...
                g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                 ...
                 // Get happiness percentage from pet instance
                ...
                if (happinessPercentage < 0.25) {
                 ...
                 // Calculate new width based on happiness percentage
        ...
        // Adding the inventory panel to the UI circle
        ...
        // Adding the score label to the UI circle
        ...
        // Adding the bed button to the UI
        ...
        // Adding the feed button to the UI 
        ...
        // Adding the gift button to the UI
        ...
        // Adding the vet button to the UI 
        ...
        // Adding the play button to the UI
        ...
        // Adding the exercise button to the UI
        ...
        // Adding the settings button to the UI
       JPanel settingsPanel = new JPanel() {
        ...
        // Adding the close button to the UI
