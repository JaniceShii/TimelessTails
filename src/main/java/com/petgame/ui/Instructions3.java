 ...
 */
public class Instructions3 extends AbstractScreen{
     ...
     */
    public Instructions3(GameManager gm) {
        this.gm = gm;
        createUIElements();
    }
    ...
    public void createUIElements() {
        ...
        JLabel descLabel = new JLabel("<html><div style='text-align: center;'>" + "Player navigates through game with mouse interactions with various buttons." +
        "There are also keyboard shortcuts that for quick execution of actions: <br>" +
            "- Ctr + i       opens the inventory<br>" +
            "- Ctr + q       opens the settings<br>" +
            "- esc           quits the game<br>" +
            "- Ctr + p       executes the pet play action that directs user to the minigame<br>" +
            "- Ctr + v       executes the take pet to vet action<br>" +
            "- Ctr + e       executes the take pet to excercise action<br>" +
            "- Ctr + z       executes the sleep pet action<br><br>" +
            "From the Main Menu, the player can choose to start a new game, continue saved game, or go to settings. <br> " + 
        ...
        continueButton.addActionListener(e -> gm.showInstructions4());
        ...
        prevButton.addActionListener(e -> gm.showInstructions2());
