...
/**
 * This class is responsible for saving {@code Pet} object data to a text file.
 * The saved data is stored in a key-value format, allowing for easy persistence and retrieval
 * of pet attributes such as name, points, health, fullness, sleep, happiness, etc.
 *
 * @version 1.0
 * @author Jugraj
 */
