...
/**
 * The SaveFileScreen class provides a GUI for selecting, loading, and deleting 
 * save files in the game. This screen displays buttons for three 
 * separate game slots and allows users to delete or load previously saved game files.
 * 
 * @version 1.0
 * @author Jugraj
 */
...
public class SaveFileScreen extends AbstractScreen {
    ...
    /**
     * Constructs a new SaveFileScreen with the specified GameManager.
     *
     * @param gm The GameManager instance managing the game state and navigation.
     */
    ...
    /**
     * Creates and initializes all UI elements for the SaveFileScreen, including buttons 
     * for selecting and deleting save files, as well as labels for UI titles.
     */
    @Override
